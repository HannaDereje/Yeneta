...
class ContentManagerAnswerService {
    ...
    updateOne(id, adminAnswer) {
        ...
        const adminAnswer2 = this.adminAnswerRepository.updateOne(id, adminAnswer);
        return new Promise((resolve, reject) => { resolve(adminAnswer2) })
    }
    deleteOne(id) {
...
module.exports = ContentManagerAnswerService
